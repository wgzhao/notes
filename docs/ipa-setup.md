...
- Following are useful techniques you can use in future labs to find your cluster specific details:
  ...
  - From Ambari how do I check the cluster name?
    ...
    ![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/hdp3/hdp3-clustername.png)
  ...
  - From Ambari how can I find external hostname of node where a component (e.g. Resource Manager or Hive) is installed?
    ...
    ![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/hdp3/hdp3-hostname.png)
  ...
  - From Ambari how can I find internal hostname of node where a component (e.g. Resource Manager or Hive) is installed?
    ...
    ![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/hdp3/hdp3-internalhostname.png)  
...
![Ambari-IPA-kerberos-1](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ambari-IPA-kerberos-1.png)
...
![Ambari-IPA-kerberos-2](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ambari-IPA-kerberos-2.png)

If all goes well, go grab a beer. 

![Ambari-IPA-kerberos-3](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ambari-IPA-kerberos-3.png)
...
![Ambari-IPA-usersync](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master//screenshots/Ambari-IPA-usersync.png)
...
- Before we can start exercising HDFS encryption, we will need to set:
  ...
  - Give keyadmin permission to view Audits screen in Ranger:
    - Settings tab > Permissions
     ![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-user-permissions.png)
...
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-login-page.png)

- Select the "TAGS" tab and click on "Create Tag"
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-select-create-tag.png)

- Create a new tag by inputing
	- Name: `Private`
	- Create
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-create-tag.png)
...
- Create a third tag named "Sensitive", however, during creation, click on "Add New Attributes" and input:
	...
	- Type: `int`
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-sensitive-tag-creation.png)

- Create a fourth tag named "EXPIRES_ON", and during creation, click on "Add New Attributes" and input:
	- Attribute Name: `expiry_date`
	- Type: `int`
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-expires-on-tag-creation.png)

- Under the "Tags" tab in the main screen you should see the list of newly created tags
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-created-tags.png)

- In the search tab search using the following:
	- Search By Type: `hive_table`
	- Search By Text: `sample_08`
	- Search
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-search-table.png)

- To associate a tag to the "sample_08" table, click on the "+" under the Tags column in the search results for "sample_08"
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-search-result.png)

- From the dropdown select `Private` and click `Add`
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-attach-tag.png)

- You should see that the "Private" tag has been associated to the "sample_08" table
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-associated-table-tags.png)
...
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-tag-item-expires-on.png)

- In the search results panel, click on the "sample_08" link
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-search-table.png)

- Scroll down and select the "Schema" tab
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-select-table-schema.png)
...
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-tag-item-sensitive.png)

- On the "sample_08" table schema page you should see the table columns with the associated tags
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Atlas-associated-column-tags.png)
...
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-navigate-to-tag-based-policies.png)

- Click on the "+" to create a new tag service
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-create-tag-service.png)

- In the tag service page input:
	- Service Name: `tags`
	- Save
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-save-tag-service.png)
...
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-add-hive-tag-service.png)
...
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-Tags-policy-list-1.png)
...
- Input the following to create the new policy
	...
	- Add
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-Tags-create-tbac.png)
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-Tags-component-permissions.png)
...
- Return to the Ranger "tags Policies" page and "Add New Policy" with the below parameters
	...
	- Under "Deny Conditions" 
		...
		- Component Permissions: (select `Hive` and enable all actions)
	- Add
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-Tags-create-abac-1.png)
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-Tags-create-abac-2.png)
...
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-Tags-tbm-tab.png)
...
- Return to the Ranger "tags Policies" page ("Access" tab) and "Add New Policy" with the below parameters
	...
	- Under "Deny Conditions" 
		...
		- Component Permissions: (select `Hive` and enable all actions)
	- Add
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-Tags-create-lba-1.png)
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-Tags-create-lba-2.png)
...
- Return to the Ranger "tags Policies" page ("Access" tab)and "Add New Policy" with the below parameters.  You may already have default policy named "EXPIRES_ON", if so, please delete it before clicking "Add New Policy" 
	...
	- Under "Deny Conditions" 
		...
		- Component Permissions: (select `Hive` and enable all actions)
	- Add
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-Tags-create-eo-1.png)
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-Tags-create-eo-2.png)
...
![Image](https://raw.githubusercontent.com/HortonworksUniversity/Security_Labs/master/screenshots/Ranger-Policy-Evaluation-Flow-with-Tags.png)
